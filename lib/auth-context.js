...
import { resolveAccess, homeRouteFor, ROLES } from "./tenancy";
...
export function AuthProvider({ children }) {
  ...
  const value = useMemo(() => ({
    ...
    // Where this person should land after signing in — the brand console for
    // anyone who manages across outlets, the working surface for floor staff.
    homeRoute: homeRouteFor(state.access.role),
